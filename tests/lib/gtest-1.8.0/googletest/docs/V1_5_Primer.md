...
So what makes a good test, and how does Google C++ Testing Framework fit in? We believe:
  ...
  1. Tests should be well _organized_ and reflect the structure of the tested code.  Google C++ Testing Framework groups related tests into test cases that can share value and subroutines. This common pattern is easy to recognize and makes tests easy to maintain. Such consistency is especially helpful when people switch projects and start to work on a new code base.
...
If you find yourself writing two or more tests that operate on similar value,
